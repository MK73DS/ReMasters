...
namespace ReMastersLib {
  ...
  /// <summary>Holder for reflection information generated from TrainerBase.proto</summary>
  public static partial class TrainerBaseReflection {

    #region Descriptor
    /// <summary>File descriptor for TrainerBase.proto</summary>
    ...
    static TrainerBaseReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChFUcmFpbmVyQmFzZS5wcm90bxIMUmVNYXN0ZXJzTGliIvgBCgtUcmFpbmVy",
            "QmFzZRIKCgJpZBgBIAEoBBIQCghhY3Rvcl9pZBgCIAEoCRIXCg90cmFpbmVy",
            "X25hbWVfaWQYAyABKAkSCgoCdTQYBCABKAUSCgoCdTUYBSABKAkSCgoCdTYY",
            "BiABKAUSCgoCdTcYByABKAUSDgoGZ2VuZGVyGAggASgFEhMKC3Bva2ViYWxs",
            "X2lkGAkgASgJEhIKCmlzX2dlbmVyaWMYCiABKAUSFQoNYmF0dGxlX2JnbV9p",
            "ZBgLIAEoCRIVCg1yZXN1bHRfYmdtX2lkGAwgASgJEhsKE2FsdF90cmFpbmVy",
            "X25hbWVfaWQYDSABKAkiPgoQVHJhaW5lckJhc2VUYWJsZRIqCgdlbnRyaWVz",
            "GAEgAygLMhkuUmVNYXN0ZXJzTGliLlRyYWluZXJCYXNlYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ReMastersLib.TrainerBase), global::ReMastersLib.TrainerBase.Parser, new[]{ "Id", "ActorId", "TrainerNameId", "U4", "U5", "U6", "U7", "Gender", "PokeballId", "IsGeneric", "BattleBgmId", "ResultBgmId", "AltTrainerNameId" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public TrainerBase(TrainerBase other) : this() {
      ...
      altTrainerNameId_ = other.altTrainerNameId_;
    ...
    /// <summary>Field number for the "alt_trainer_name_id" field.</summary>
    public const int AltTrainerNameIdFieldNumber = 13;
    private string altTrainerNameId_ = "";
    /// <summary>
    /// trainer_name_xx.lsd
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string AltTrainerNameId {
      get { return altTrainerNameId_; }
      set {
        altTrainerNameId_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(TrainerBase other) {
      ...
      if (AltTrainerNameId != other.AltTrainerNameId) return false;
    ...
    public override int GetHashCode() {
      ...
      if (AltTrainerNameId.Length != 0) hash ^= AltTrainerNameId.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (AltTrainerNameId.Length != 0) {
        output.WriteRawTag(106);
        output.WriteString(AltTrainerNameId);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (AltTrainerNameId.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(AltTrainerNameId);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(TrainerBase other) {
      ...
      if (other.AltTrainerNameId.Length != 0) {
        AltTrainerNameId = other.AltTrainerNameId;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 106: {
            AltTrainerNameId = input.ReadString();
            break;
          }
        }
      }
